...
func (self *BlockChain) reorg(oldBlock, newBlock *types.Block) error {
	var (
		...
		deletedLogs       state.Logs
		deletedLogsByHash = make(map[common.Hash]state.Logs)
...
func (self *BlockChain) postChainEvents(events []interface{}, logs state.Logs) {
