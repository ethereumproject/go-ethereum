...
[![Build
Status](https://travis-ci.org/eth-classic/go-ethereum.png?branch=master)](https://travis-ci.org/ethereum/go-ethereum)
...
`go get github.com/eth-classic/go-ethereum`.
