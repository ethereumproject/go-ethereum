...
func NewTrieSync(root common.Hash, database ethdb.Database, callback TrieSyncLeafCallback) *Sync {
	ts := &Sync{
		database: database,
...
func (s *Sync) AddSubTrie(root common.Hash, depth int, parent common.Hash, callback TrieSyncLeafCallback) {
